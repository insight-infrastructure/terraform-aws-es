...
variable "public_ports" {
  description = "Open allowed port range. (e.g. `443`)"
  type        = list(number)
  default     = []
}

variable "private_ports" {
  description = "Open allowed port range with private cidr blocks"
  type        = list(number)
  default     = []
}

variable "private_cidr_blocks" {
  description = "List of allowed cidr blocks for private_ports"
  type        = list(number)
  default     = []
}
